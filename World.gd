...
func changePlayerWeapon():
	var Number = floor(rand_range(0,3))
	if Number == 0:
		$Player/WeaponSprite.texture = preload("res://slingshotPrototype.png")
		$Player.attack = preload("res://Pebble_Ammo.tscn")
		$Player/WeaponDelayTimer.wait_time = 0.5
	elif Number == 1:
		$Player/WeaponSprite.texture = preload("res://Boomerrang place-in.png")
		$Player.attack = preload("res://Boomerrang.tscn")
		$Player/WeaponDelayTimer.wait_time = 0.3
